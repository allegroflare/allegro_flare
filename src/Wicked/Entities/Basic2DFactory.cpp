...
Wicked::Entities::Basic2D* Basic2DFactory::create_tile_map(std::string map_json_filename, std::string map_name)
{
   ...
   //Wicked::TileMaps::Basic2D *created_map = nullptr;
   //Tileo::Atlas *tile_atlas = nullptr; //  = tmj_mesh_loader.get_tile_atlas();
   //Tileo::Mesh *tile_mesh = nullptr; // = tmj_mesh_loader.get_mesh();
   //Tileo::TileMap *collision_tile_mesh = nullptr; //tmj_mesh_loader.get_collision_tile_map();


   //created_map = new Wicked::TileMaps::Basic2D;
