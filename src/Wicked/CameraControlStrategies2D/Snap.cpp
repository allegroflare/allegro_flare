...
void Snap::update()
{
   if (!(get_camera()))
   {
      ...
      error_message << "[Wicked::CameraControlStrategies2D::Snap::update]: error: guard \"get_camera()\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Wicked::CameraControlStrategies2D::Snap::update]: error: guard \"get_camera()\" not met");
   }
   if (!(entity_to_follow))
   {
      std::stringstream error_message;
      error_message << "[Wicked::CameraControlStrategies2D::Snap::update]: error: guard \"entity_to_follow\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Wicked::CameraControlStrategies2D::Snap::update]: error: guard \"entity_to_follow\" not met");
   }
