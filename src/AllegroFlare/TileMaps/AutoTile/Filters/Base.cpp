...
bool Base::matrix_matches(std::vector<std::vector<int>> match_matrix, int at_coord_x, int at_coord_y, int match_matrix_offset_x, int match_matrix_offset_y, bool ignore_if_negative_tile_value_on_match_matrix, bool out_of_bounds_on_input_is_positive_match)
{
   if (!(AllegroFlare::TileMaps::AutoTile::FilterMatrix::STATIC_is_valid(match_matrix)))
   {
      std::stringstream error_message;
