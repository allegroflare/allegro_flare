...
JoystickDisconnected::JoystickDisconnected(AllegroFlare::BitmapBin* bitmap_bin, AllegroFlare::FontBin* font_bin, float x, float y, float width, float height, float created_at, std::string name)
...
void JoystickDisconnected::set_x(float x)
{
   this->x = x;
}


void JoystickDisconnected::set_y(float y)
{
   this->y = y;
}


void JoystickDisconnected::set_width(float width)
{
   this->width = width;
}


void JoystickDisconnected::set_height(float height)
{
   this->height = height;
}


void JoystickDisconnected::set_created_at(float created_at)
{
   this->created_at = created_at;
}


void JoystickDisconnected::set_name(std::string name)
{
   this->name = name;
}


float JoystickDisconnected::get_x() const
{
   return x;
}


float JoystickDisconnected::get_y() const
{
   return y;
}


float JoystickDisconnected::get_width() const
{
   return width;
}


float JoystickDisconnected::get_height() const
{
   return height;
}


float JoystickDisconnected::get_created_at() const
{
   return created_at;
}


std::string JoystickDisconnected::get_name() const
{
   return name;
}


void JoystickDisconnected::render()
{
   if (!(al_is_system_installed()))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Elements::NotificationRenderers::JoystickDisconnected::render]: error: guard \"al_is_system_installed()\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Elements::NotificationRenderers::JoystickDisconnected::render]: error: guard \"al_is_system_installed()\" not met");
   }
   if (!(al_is_font_addon_initialized()))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Elements::NotificationRenderers::JoystickDisconnected::render]: error: guard \"al_is_font_addon_initialized()\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Elements::NotificationRenderers::JoystickDisconnected::render]: error: guard \"al_is_font_addon_initialized()\" not met");
   }
   draw_achievement_box("Joystick Disconnected", name);
   return;
}

void JoystickDisconnected::draw_achievement_box(std::string title, std::string description)
{
...
ALLEGRO_FONT* JoystickDisconnected::obtain_item_title_font()
{
   if (!(font_bin))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Elements::NotificationRenderers::JoystickDisconnected::obtain_item_title_font]: error: guard \"font_bin\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Elements::NotificationRenderers::JoystickDisconnected::obtain_item_title_font]: error: guard \"font_bin\" not met");
   }
   return font_bin->auto_get("Inter-Regular.ttf -32");
}

ALLEGRO_FONT* JoystickDisconnected::obtain_item_description_font()
{
   if (!(font_bin))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Elements::NotificationRenderers::JoystickDisconnected::obtain_item_description_font]: error: guard \"font_bin\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Elements::NotificationRenderers::JoystickDisconnected::obtain_item_description_font]: error: guard \"font_bin\" not met");
   }
   return font_bin->auto_get("Inter-Bold.ttf -26");
}

ALLEGRO_FONT* JoystickDisconnected::obtain_icon_font()
{
   if (!(font_bin))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Elements::NotificationRenderers::JoystickDisconnected::obtain_icon_font]: error: guard \"font_bin\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Elements::NotificationRenderers::JoystickDisconnected::obtain_icon_font]: error: guard \"font_bin\" not met");
   }
   return font_bin->auto_get("fa-solid-900.ttf -50");
}

void JoystickDisconnected::draw_unicode_character(ALLEGRO_FONT* font, ALLEGRO_COLOR color, int x, int y, uint32_t icon, int flags)
{
