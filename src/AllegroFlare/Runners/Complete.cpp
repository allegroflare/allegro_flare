...
void Complete::initialize()
{
   ...
   saving_and_loading.set_start_style(game_configuration->get_saving_and_loading_start_style());
   saving_and_loading.set_save_style(game_configuration->get_saving_and_loading_save_style());
   saving_and_loading.set_load_style(game_configuration->get_saving_and_loading_load_style());
