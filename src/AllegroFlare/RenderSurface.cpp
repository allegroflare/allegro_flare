...
void RenderSurface::setup_surface(int w, int h, int multisamples, int depth)
{
...
void RenderSurface::set_as_target(bool clear_to_color, bool clear_depth)
{
   if (!surface_is_setup) throw std::runtime_error("AllegroFlare::RenderSurface::set_as_target: error: not setup");
...
void RenderSurface::set_clear_color(ALLEGRO_COLOR clear_color)
{
...
ALLEGRO_COLOR RenderSurface::get_clear_color()
{
   return clear_color;
}


ALLEGRO_BITMAP *RenderSurface::get_surface_bitmap()
{
   if (!surface_is_setup) throw std::runtime_error("AllegroFlare::RenderSurface::get_surface_bitmap: error: not setup");
   return surface;
}
