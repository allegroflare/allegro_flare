...
void Rulers::draw_dimentional_grid(float x, float y, float z, float spacing)
{
   if (!(al_is_system_installed()))
   {
      ...
      error_message << "[Rulers::draw_dimentional_grid]: error: guard \"al_is_system_installed()\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("Rulers::draw_dimentional_grid: error: guard \"al_is_system_installed()\" not met");
   }
   if (!(al_is_primitives_addon_initialized()))
   {
      std::stringstream error_message;
      error_message << "[Rulers::draw_dimentional_grid]: error: guard \"al_is_primitives_addon_initialized()\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("Rulers::draw_dimentional_grid: error: guard \"al_is_primitives_addon_initialized()\" not met");
   }
