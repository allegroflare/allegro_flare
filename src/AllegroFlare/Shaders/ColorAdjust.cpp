...
ColorAdjust::ColorAdjust()
   : AllegroFlare::Shaders::Base(AllegroFlare::Shaders::ColorAdjust::TYPE, obtain_vertex_source(), obtain_fragment_source())
...
ALLEGRO_COLOR ColorAdjust::get_flat_color() const
{
   return flat_color;
}


float ColorAdjust::get_flat_color_intensity() const
{
   return flat_color_intensity;
}


float ColorAdjust::get_darkness() const
{
   return darkness;
}


float ColorAdjust::get_saturation() const
{
   return saturation;
}


float ColorAdjust::get_red_channel_multiplier() const
{
   return red_channel_multiplier;
}


float ColorAdjust::get_green_channel_multiplier() const
{
   return green_channel_multiplier;
}


float ColorAdjust::get_blue_channel_multiplier() const
{
   return blue_channel_multiplier;
}


float ColorAdjust::get_hue_rotation() const
{
   return hue_rotation;
}


void ColorAdjust::initialize()
{
   if (!initialized) AllegroFlare::Shaders::Base::initialize();
   initialized = true;
}

void ColorAdjust::set_flat_color(ALLEGRO_COLOR flat_color)
{
...
void ColorAdjust::set_saturation(float saturation)
{
   if (!((saturation >= 0.0f)))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Shaders::ColorAdjust::set_saturation]: error: guard \"(saturation >= 0.0f)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Shaders::ColorAdjust::set_saturation]: error: guard \"(saturation >= 0.0f)\" not met");
   }
   if (!((saturation <= 2.0f)))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Shaders::ColorAdjust::set_saturation]: error: guard \"(saturation <= 2.0f)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Shaders::ColorAdjust::set_saturation]: error: guard \"(saturation <= 2.0f)\" not met");
   }
...
void ColorAdjust::set_flat_color_intensity(float flat_color_intensity)
{
   if (!((flat_color_intensity >= 0.0f)))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Shaders::ColorAdjust::set_flat_color_intensity]: error: guard \"(flat_color_intensity >= 0.0f)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Shaders::ColorAdjust::set_flat_color_intensity]: error: guard \"(flat_color_intensity >= 0.0f)\" not met");
   }
   if (!((flat_color_intensity <= 1.0f)))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Shaders::ColorAdjust::set_flat_color_intensity]: error: guard \"(flat_color_intensity <= 1.0f)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Shaders::ColorAdjust::set_flat_color_intensity]: error: guard \"(flat_color_intensity <= 1.0f)\" not met");
   }
...
void ColorAdjust::set_darkness(float darkness)
{
...
void ColorAdjust::set_red_channel_multiplier(float red_channel_multiplier)
{
...
void ColorAdjust::set_green_channel_multiplier(float green_channel_multiplier)
{
...
void ColorAdjust::set_blue_channel_multiplier(float blue_channel_multiplier)
{
...
void ColorAdjust::set_hue_rotation(float hue_rotation)
{
...
void ColorAdjust::activate()
{
   if (!(initialized))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Shaders::ColorAdjust::activate]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Shaders::ColorAdjust::activate]: error: guard \"initialized\" not met");
   }
...
void ColorAdjust::set_values_to_activated_shader()
{
...
std::string ColorAdjust::obtain_vertex_source()
{
...
std::string ColorAdjust::obtain_fragment_source()
{
   static const std::string source = R"DELIM(
     #ifdef GL_ES
