...
std::string Complete::build_save_file_content_for_current_game()
{
   // TODO: This method
   AllegroFlare::Logger::throw_error(THIS_CLASS_AND_METHOD_NAME,
      "Not implemented in the base class. This method must be implemented in the derived class."
...
std::vector<std::pair<std::string, std::string>> Complete::obtain_context_sensitive_menu_items_for_starting_or_loading_the_game()
{
...
std::string Complete::build_copyright_text(ReleaseInfo* release_info)
{
   ...
   AllegroFlare::TemplatedText templated_text(
      "[[COPYRIGHT_SYMBOL]] 2026 CLUBCATT Games         clubcatt.com         version [[VERSION_NUMBER]]",
      {
