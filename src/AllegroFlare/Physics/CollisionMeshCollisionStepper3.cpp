...
#include <AllegroFlare/Physics/CollisionMeshCollisionStepper3.hpp>
...
CollisionMeshCollisionStepper3::CollisionMeshCollisionStepper3(std::vector<AllegroFlare::Physics::CollisionMesh*> collision_meshes, std::vector<std::pair<AllegroFlare::Placement3D*, AllegroFlare::Physics::CollisionMesh*>> collision_meshes_with_placements, std::vector<std::tuple<AllegroFlare::Vec3D*, AllegroFlare::Vec3D*, void*>>* _entities, float face_collision_stepout)
   : collision_meshes(collision_meshes)
   , collision_meshes_with_placements(collision_meshes_with_placements)
   , _entities(_entities)
...
CollisionMeshCollisionStepper3::~CollisionMeshCollisionStepper3()
{
}


void CollisionMeshCollisionStepper3::set_collision_meshes(std::vector<AllegroFlare::Physics::CollisionMesh*> collision_meshes)
{
   this->collision_meshes = collision_meshes;
}


void CollisionMeshCollisionStepper3::set_collision_meshes_with_placements(std::vector<std::pair<AllegroFlare::Placement3D*, AllegroFlare::Physics::CollisionMesh*>> collision_meshes_with_placements)
{
   this->collision_meshes_with_placements = collision_meshes_with_placements;
}


void CollisionMeshCollisionStepper3::set__entities(std::vector<std::tuple<AllegroFlare::Vec3D*, AllegroFlare::Vec3D*, void*>>* _entities)
{
   this->_entities = _entities;
}


void CollisionMeshCollisionStepper3::set_face_collision_stepout(float face_collision_stepout)
{
   this->face_collision_stepout = face_collision_stepout;
}


void CollisionMeshCollisionStepper3::set_stepout_strategy(AllegroFlare::Physics::CollisionMeshCollisionStepper3::StepoutStrategy stepout_strategy)
{
   this->stepout_strategy = stepout_strategy;
}


void CollisionMeshCollisionStepper3::set_redirect_strategy(AllegroFlare::Physics::CollisionMeshCollisionStepper3::RedirectStrategy redirect_strategy)
{
   this->redirect_strategy = redirect_strategy;
}


void CollisionMeshCollisionStepper3::set_air_drag(float air_drag)
{
   this->air_drag = air_drag;
}


void CollisionMeshCollisionStepper3::set_gravity(float gravity)
{
   this->gravity = gravity;
}


void CollisionMeshCollisionStepper3::set_on_collision_with_face(std::function<void(AllegroFlare::Physics::CollisionMeshCollisionStepInfo*, AllegroFlare::Vec3D*)> on_collision_with_face)
{
   this->on_collision_with_face = on_collision_with_face;
}


void CollisionMeshCollisionStepper3::set_num_collision_steps(int num_collision_steps)
{
   this->num_collision_steps = num_collision_steps;
}


std::vector<AllegroFlare::Physics::CollisionMesh*> CollisionMeshCollisionStepper3::get_collision_meshes() const
{
   return collision_meshes;
}


std::vector<std::pair<AllegroFlare::Placement3D*, AllegroFlare::Physics::CollisionMesh*>> CollisionMeshCollisionStepper3::get_collision_meshes_with_placements() const
{
   return collision_meshes_with_placements;
}


std::vector<std::tuple<AllegroFlare::Vec3D*, AllegroFlare::Vec3D*, void*>>* CollisionMeshCollisionStepper3::get__entities() const
{
   return _entities;
}


float CollisionMeshCollisionStepper3::get_face_collision_stepout() const
{
   return face_collision_stepout;
}


AllegroFlare::Physics::CollisionMeshCollisionStepper3::StepoutStrategy CollisionMeshCollisionStepper3::get_stepout_strategy() const
{
   return stepout_strategy;
}


AllegroFlare::Physics::CollisionMeshCollisionStepper3::RedirectStrategy CollisionMeshCollisionStepper3::get_redirect_strategy() const
{
   return redirect_strategy;
}


bool CollisionMeshCollisionStepper3::get_apply_environmental_forces() const
{
   return apply_environmental_forces;
}


float CollisionMeshCollisionStepper3::get_air_drag() const
{
   return air_drag;
}


float CollisionMeshCollisionStepper3::get_gravity() const
{
   return gravity;
}


std::vector<AllegroFlare::Physics::CollisionMeshCollisionStepInfo> CollisionMeshCollisionStepper3::get_collision_step_infos() const
{
   return collision_step_infos;
}


std::function<void(AllegroFlare::Physics::CollisionMeshCollisionStepInfo*, AllegroFlare::Vec3D*)> CollisionMeshCollisionStepper3::get_on_collision_with_face() const
{
   return on_collision_with_face;
}


int CollisionMeshCollisionStepper3::get_num_collision_steps() const
{
   return num_collision_steps;
}


int CollisionMeshCollisionStepper3::num_collision_step_infos()
{
   return collision_step_infos.size();
}

void CollisionMeshCollisionStepper3::disable_applying_environmental_forces()
{
   apply_environmental_forces = false;
   return;
}

void CollisionMeshCollisionStepper3::enable_applying_environmental_forces()
{
   apply_environmental_forces = false;
   return;
}

void CollisionMeshCollisionStepper3::move_to_time_of_collision_and_react_to_collision(AllegroFlare::Vec3D* position_, AllegroFlare::Vec3D* velocity_, float time_to_collision, AllegroFlare::Vec3D* face_normal_, float face_collision_stepout, AllegroFlare::Physics::CollisionMeshCollisionStepper3::StepoutStrategy stepout_strategy, AllegroFlare::Physics::CollisionMeshCollisionStepper3::RedirectStrategy redirect_strategy)
{
   if (!(position_))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Physics::CollisionMeshCollisionStepper3::move_to_time_of_collision_and_react_to_collision]: error: guard \"position_\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Physics::CollisionMeshCollisionStepper3::move_to_time_of_collision_and_react_to_collision]: error: guard \"position_\" not met");
   }
   if (!(velocity_))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Physics::CollisionMeshCollisionStepper3::move_to_time_of_collision_and_react_to_collision]: error: guard \"velocity_\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Physics::CollisionMeshCollisionStepper3::move_to_time_of_collision_and_react_to_collision]: error: guard \"velocity_\" not met");
   }
   if (!(face_normal_))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Physics::CollisionMeshCollisionStepper3::move_to_time_of_collision_and_react_to_collision]: error: guard \"face_normal_\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Physics::CollisionMeshCollisionStepper3::move_to_time_of_collision_and_react_to_collision]: error: guard \"face_normal_\" not met");
   }
   ...
   {
      case AllegroFlare::Physics::CollisionMeshCollisionStepper3::StepoutStrategy::STEPOUT_REVERSE_VELOCITY: {
      ...
      case AllegroFlare::Physics::CollisionMeshCollisionStepper3::StepoutStrategy::STEPOUT_REFLECT_SURFACE: {
      ...
      case AllegroFlare::Physics::CollisionMeshCollisionStepper3::StepoutStrategy::STEPOUT_EXTRUDE_FACE_NORMAL: {
         final_offset_from_intersection_point = face_normal * face_collision_stepout;
      } break;

      case AllegroFlare::Physics::CollisionMeshCollisionStepper3::StepoutStrategy::STEPOUT_NONE: {
         final_offset_from_intersection_point = { 0, 0, 0 };
      } break;

      case AllegroFlare::Physics::CollisionMeshCollisionStepper3::StepoutStrategy::STEPOUT_DIRECTLY_UP: {
      ...
      default: {
         AllegroFlare::Logger::throw_error(
            "AllegroFlare::Physics::CollisionMeshCollisionStepper3::move_to_time_of_collision_and_react_to_collision",
   ...
   {
      case AllegroFlare::Physics::CollisionMeshCollisionStepper3::RedirectStrategy::REDIRECT_REFLECT_SURFACE: {
         // TODO: Note that normalizing here if result is 0 0 0 will cause NaN NaN NaN
         vec3d reflect_normal = reflect(velocity, face_normal).normalized();
         velocity = reflect_normal * velocity.get_magnitude();
      } break;

      case AllegroFlare::Physics::CollisionMeshCollisionStepper3::RedirectStrategy::REDIRECT_COMPLETE_STOP: {
         velocity = { 0, 0, 0 };
      } break;

      case AllegroFlare::Physics::CollisionMeshCollisionStepper3::RedirectStrategy::REDIRECT_STOP_VERTICAL: {
         velocity.y = 0;
      } break;

      case AllegroFlare::Physics::CollisionMeshCollisionStepper3::RedirectStrategy::REDIRECT_SLIDE_ALONG_SURFACE: {
...
float CollisionMeshCollisionStepper3::calculate_collisions(float min_entity_velocity_magnitude)
{
   if (!(_entities))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Physics::CollisionMeshCollisionStepper3::calculate_collisions]: error: guard \"_entities\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Physics::CollisionMeshCollisionStepper3::calculate_collisions]: error: guard \"_entities\" not met");
   }
   ...
   for (auto &entity_info : entities)
   {
      ...
      ALLEGRO_TRANSFORM t;
      AllegroFlare::Useful3D::Ray ray_to_use;
      auto process_faces = [&](AllegroFlare::Placement3D *mesh_placement, auto &faces)
      {
         // Build reverse transform on the placement
         // Reverse transform the coordinates on the ray
         AllegroFlare::Useful3D::Ray ray_to_use = ray;
         if (mesh_placement)
         {
            mesh_placement->build_reverse_transform(&t);
            al_transform_coordinates_3d(&t, &ray_to_use.orig.x, &ray_to_use.orig.y, &ray_to_use.orig.z);
            al_transform_coordinates_3d(&t, &ray_to_use.dir.x, &ray_to_use.dir.y, &ray_to_use.dir.z);
         }
         ...
         for (auto &face : faces)
         {
            ...
            if (face.intersect(&ray_to_use, &intersect_info))
            {
      ...
      for (auto &collision_mesh : collision_meshes)
      {
         ...
         process_faces(nullptr, collision_mesh->get_faces_ref());
         // TODO: process indexed faces (that may be disabled)
         process_faces(nullptr, collision_mesh->get_dynamic_faces_ref());
      }


      for (auto &collision_mesh_with_placement : collision_meshes_with_placements)
      {
         //meshes
         if (collision_mesh_with_placement.second->get_disabled()) continue;

         process_faces(
            collision_mesh_with_placement.first,
            collision_mesh_with_placement.second->get_faces_ref()
         );
         // TODO: process indexed faces (that may be disabled)
         process_faces(
            collision_mesh_with_placement.first,
            collision_mesh_with_placement.second->get_dynamic_faces_ref()
         );
      }
...
void CollisionMeshCollisionStepper3::apply_gravity_and_air_drag(float total_duration)
{
   //
...
void CollisionMeshCollisionStepper3::step(float total_duration)
{
   if (!(_entities))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Physics::CollisionMeshCollisionStepper3::step]: error: guard \"_entities\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Physics::CollisionMeshCollisionStepper3::step]: error: guard \"_entities\" not met");
   }
   if (apply_environmental_forces) apply_gravity_and_air_drag(total_duration);

   //if (!collision_mesh && collision_meshes.empty())
   //{
      // There are no collision meshes to run calculations against. The entities should theoretically
      // just have their positions updated by their velocities.
   //}
   ...
   while (time_left_in_timestep > min_time_step)
   {
      ...
      //
      // Collision Sweeps
      // Calculate *all* collisions, find the soonest time, move all to that time and continue
      //
      for (auto &collision_step_info : collision_step_infos)
      {
         ...
         if (entity_will_collide_at_least_time && entity_does_collide_with_face)
         {
            ...
            move_to_time_of_collision_and_react_to_collision(
               ...
               stepout_strategy,
               redirect_strategy
               //AllegroFlare::Physics::CollisionMeshCollisionStepper3::StepoutStrategy::STEPOUT_REVERSE_VELOCITY,
               //AllegroFlare::Physics::CollisionMeshCollisionStepper3::RedirectStrategy::REDIRECT_SLIDE_ALONG_SURFACE,
            );
            ...
            //  type: AllegroFlare::Physics::CollisionMeshCollisionStepper3::StepoutStrategy
            //  default_argument: StepoutStrategy::STEPOUT_REVERSE_VELOCITY
            //- name: redirect_strategy
            //  type: AllegroFlare::Physics::CollisionMeshCollisionStepper3::RedirectStrategy
      ...
      {
         AllegroFlare::Logger::throw_error(
            "AllegroFlare::Physics::CollisionMeshCollisionStepper3::step",
...
std::string CollisionMeshCollisionStepper3::to_string(AllegroFlare::Physics::CollisionMeshCollisionStepper3::StepoutStrategy stepout_strategy)
{
   switch (stepout_strategy)
   {
...
std::string CollisionMeshCollisionStepper3::to_string(AllegroFlare::Physics::CollisionMeshCollisionStepper3::RedirectStrategy redirect_strategy)
{
   switch (redirect_strategy)
   {
...
void CollisionMeshCollisionStepper3::draw_3d_line(AllegroFlare::Vec3D start, AllegroFlare::Vec3D end, ALLEGRO_COLOR col)
{
