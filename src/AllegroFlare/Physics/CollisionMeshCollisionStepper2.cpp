...
#include <AllegroFlare/Physics/CollisionMeshCollisionStepper2.hpp>
...
CollisionMeshCollisionStepper2::CollisionMeshCollisionStepper2(std::vector<AllegroFlare::Physics::CollisionMesh*> collision_meshes, std::vector<std::tuple<AllegroFlare::Vec3D*, AllegroFlare::Vec3D*, void*>>* _entities, float face_collision_stepout)
...
CollisionMeshCollisionStepper2::~CollisionMeshCollisionStepper2()
{
}


void CollisionMeshCollisionStepper2::set_collision_meshes(std::vector<AllegroFlare::Physics::CollisionMesh*> collision_meshes)
{
   this->collision_meshes = collision_meshes;
}


void CollisionMeshCollisionStepper2::set__entities(std::vector<std::tuple<AllegroFlare::Vec3D*, AllegroFlare::Vec3D*, void*>>* _entities)
{
   this->_entities = _entities;
}


void CollisionMeshCollisionStepper2::set_face_collision_stepout(float face_collision_stepout)
{
   this->face_collision_stepout = face_collision_stepout;
}


void CollisionMeshCollisionStepper2::set_stepout_strategy(AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy stepout_strategy)
{
   this->stepout_strategy = stepout_strategy;
}


void CollisionMeshCollisionStepper2::set_redirect_strategy(AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy redirect_strategy)
{
   this->redirect_strategy = redirect_strategy;
}


void CollisionMeshCollisionStepper2::set_air_drag(float air_drag)
{
   this->air_drag = air_drag;
}


void CollisionMeshCollisionStepper2::set_gravity(float gravity)
{
   this->gravity = gravity;
}


void CollisionMeshCollisionStepper2::set_on_collision_with_face(std::function<void(AllegroFlare::Physics::CollisionMeshCollisionStepInfo*, AllegroFlare::Vec3D*)> on_collision_with_face)
{
   this->on_collision_with_face = on_collision_with_face;
}


void CollisionMeshCollisionStepper2::set_num_collision_steps(int num_collision_steps)
{
   this->num_collision_steps = num_collision_steps;
}


std::vector<AllegroFlare::Physics::CollisionMesh*> CollisionMeshCollisionStepper2::get_collision_meshes() const
{
   return collision_meshes;
}


std::vector<std::tuple<AllegroFlare::Vec3D*, AllegroFlare::Vec3D*, void*>>* CollisionMeshCollisionStepper2::get__entities() const
{
   return _entities;
}


float CollisionMeshCollisionStepper2::get_face_collision_stepout() const
{
   return face_collision_stepout;
}


AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy CollisionMeshCollisionStepper2::get_stepout_strategy() const
{
   return stepout_strategy;
}


AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy CollisionMeshCollisionStepper2::get_redirect_strategy() const
{
   return redirect_strategy;
}


bool CollisionMeshCollisionStepper2::get_apply_environmental_forces() const
{
   return apply_environmental_forces;
}


float CollisionMeshCollisionStepper2::get_air_drag() const
{
   return air_drag;
}


float CollisionMeshCollisionStepper2::get_gravity() const
{
   return gravity;
}


std::vector<AllegroFlare::Physics::CollisionMeshCollisionStepInfo> CollisionMeshCollisionStepper2::get_collision_step_infos() const
{
   return collision_step_infos;
}


std::function<void(AllegroFlare::Physics::CollisionMeshCollisionStepInfo*, AllegroFlare::Vec3D*)> CollisionMeshCollisionStepper2::get_on_collision_with_face() const
{
   return on_collision_with_face;
}


int CollisionMeshCollisionStepper2::get_num_collision_steps() const
{
   return num_collision_steps;
}


int CollisionMeshCollisionStepper2::num_collision_step_infos()
{
   return collision_step_infos.size();
}

void CollisionMeshCollisionStepper2::disable_applying_environmental_forces()
{
   apply_environmental_forces = false;
   return;
}

void CollisionMeshCollisionStepper2::enable_applying_environmental_forces()
{
   apply_environmental_forces = false;
   return;
}

void CollisionMeshCollisionStepper2::move_to_time_of_collision_and_react_to_collision(AllegroFlare::Vec3D* position_, AllegroFlare::Vec3D* velocity_, float time_to_collision, AllegroFlare::Vec3D* face_normal_, float face_collision_stepout, AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy stepout_strategy, AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy redirect_strategy)
{
   if (!(position_))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Physics::CollisionMeshCollisionStepper2::move_to_time_of_collision_and_react_to_collision]: error: guard \"position_\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Physics::CollisionMeshCollisionStepper2::move_to_time_of_collision_and_react_to_collision]: error: guard \"position_\" not met");
   }
   if (!(velocity_))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Physics::CollisionMeshCollisionStepper2::move_to_time_of_collision_and_react_to_collision]: error: guard \"velocity_\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Physics::CollisionMeshCollisionStepper2::move_to_time_of_collision_and_react_to_collision]: error: guard \"velocity_\" not met");
   }
   if (!(face_normal_))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Physics::CollisionMeshCollisionStepper2::move_to_time_of_collision_and_react_to_collision]: error: guard \"face_normal_\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Physics::CollisionMeshCollisionStepper2::move_to_time_of_collision_and_react_to_collision]: error: guard \"face_normal_\" not met");
   }
   ...
   {
      case AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy::STEPOUT_REVERSE_VELOCITY: {
      ...
      case AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy::STEPOUT_REFLECT_SURFACE: {
      ...
      case AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy::STEPOUT_EXTRUDE_FACE_NORMAL: {
         final_offset_from_intersection_point = face_normal * face_collision_stepout;
      } break;

      case AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy::STEPOUT_NONE: {
         final_offset_from_intersection_point = { 0, 0, 0 };
      } break;

      case AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy::STEPOUT_DIRECTLY_UP: {
      ...
      default: {
         AllegroFlare::Logger::throw_error(
            "AllegroFlare::Physics::CollisionMeshCollisionStepper2::move_to_time_of_collision_and_react_to_collision",
   ...
   {
      case AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy::REDIRECT_REFLECT_SURFACE: {
         // TODO: Note that normalizing here if result is 0 0 0 will cause NaN NaN NaN
         vec3d reflect_normal = reflect(velocity, face_normal).normalized();
         velocity = reflect_normal * velocity.get_magnitude();
      } break;

      case AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy::REDIRECT_COMPLETE_STOP: {
         velocity = { 0, 0, 0 };
      } break;

      case AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy::REDIRECT_STOP_VERTICAL: {
         velocity.y = 0;
      } break;

      case AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy::REDIRECT_SLIDE_ALONG_SURFACE: {
...
float CollisionMeshCollisionStepper2::calculate_collisions(float min_entity_velocity_magnitude)
{
   if (!(_entities))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Physics::CollisionMeshCollisionStepper2::calculate_collisions]: error: guard \"_entities\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Physics::CollisionMeshCollisionStepper2::calculate_collisions]: error: guard \"_entities\" not met");
   }
...
void CollisionMeshCollisionStepper2::apply_gravity_and_air_drag(float total_duration)
{
   //
...
void CollisionMeshCollisionStepper2::step(float total_duration)
{
   if (!(_entities))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::Physics::CollisionMeshCollisionStepper2::step]: error: guard \"_entities\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::Physics::CollisionMeshCollisionStepper2::step]: error: guard \"_entities\" not met");
   }
   ...
   while (time_left_in_timestep > min_time_step)
   {
      ...
      for (auto &collision_step_info : collision_step_infos)
      {
         ...
         if (entity_will_collide_at_least_time && entity_does_collide_with_face)
         {
            ...
            move_to_time_of_collision_and_react_to_collision(
               ...
               stepout_strategy,
               redirect_strategy
               //AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy::STEPOUT_REVERSE_VELOCITY,
               //AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy::REDIRECT_SLIDE_ALONG_SURFACE,
            );
            ...
            //  type: AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy
            //  default_argument: StepoutStrategy::STEPOUT_REVERSE_VELOCITY
            //- name: redirect_strategy
            //  type: AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy
      ...
      {
         AllegroFlare::Logger::throw_error(
            "AllegroFlare::Physics::CollisionMeshCollisionStepper2::step",
...
std::string CollisionMeshCollisionStepper2::to_string(AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy stepout_strategy)
{
   switch (stepout_strategy)
   {
...
std::string CollisionMeshCollisionStepper2::to_string(AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy redirect_strategy)
{
   switch (redirect_strategy)
   {
...
void CollisionMeshCollisionStepper2::draw_3d_line(AllegroFlare::Vec3D start, AllegroFlare::Vec3D end, ALLEGRO_COLOR col)
{
