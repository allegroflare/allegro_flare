...
AllegroFlare::DialogSystem::Characters::Basic* CharacterFactory::create_basic_character(std::string display_name, std::string avatar_thumbnail_identifier, std::string avatar_portrait_identifier)
{
