...
DialogSystem::DialogSystem(AllegroFlare::BitmapBin* bitmap_bin, AllegroFlare::FontBin* font_bin, AllegroFlare::EventEmitter* event_emitter)
   ...
   , interparsable_with_options_on_operational_chunk_func_user_data(nullptr)
   ...
   , interparsable_with_options_on_reveal_breakout_list_box({})
   , interparsable_with_options_on_breakout_list_box_cursor_move({})
   , interparsable_with_options_on_breakout_list_box_cursor_choose({})
   ...
   , standard_dialog_box_text_emphasis_color(DEFAULT_STANDARD_DIALOG_BOX_TEXT_EMPHASIS_COLOR)
...
void DialogSystem::set_interparsable_with_options_on_operational_chunk_func(std::function<void(std::string, AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions*, void*)> interparsable_with_options_on_operational_chunk_func)
{
   this->interparsable_with_options_on_operational_chunk_func = interparsable_with_options_on_operational_chunk_func;
}


void DialogSystem::set_interparsable_with_options_on_operational_chunk_func_user_data(void* interparsable_with_options_on_operational_chunk_func_user_data)
{
   this->interparsable_with_options_on_operational_chunk_func_user_data = interparsable_with_options_on_operational_chunk_func_user_data;
}
...
void DialogSystem::set_interparsable_with_options_on_reveal_breakout_list_box(std::function<void(AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions*)> interparsable_with_options_on_reveal_breakout_list_box)
{
   this->interparsable_with_options_on_reveal_breakout_list_box = interparsable_with_options_on_reveal_breakout_list_box;
}


void DialogSystem::set_interparsable_with_options_on_breakout_list_box_cursor_move(std::function<void(AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions*)> interparsable_with_options_on_breakout_list_box_cursor_move)
{
   this->interparsable_with_options_on_breakout_list_box_cursor_move = interparsable_with_options_on_breakout_list_box_cursor_move;
}


void DialogSystem::set_interparsable_with_options_on_breakout_list_box_cursor_choose(std::function<void(AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions*)> interparsable_with_options_on_breakout_list_box_cursor_choose)
{
   this->interparsable_with_options_on_breakout_list_box_cursor_choose = interparsable_with_options_on_breakout_list_box_cursor_choose;
}
...
void DialogSystem::set_standard_dialog_box_text_emphasis_color(ALLEGRO_COLOR standard_dialog_box_text_emphasis_color)
{
...
std::function<void(std::string, AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions*, void*)> DialogSystem::get_interparsable_with_options_on_operational_chunk_func() const
{
   return interparsable_with_options_on_operational_chunk_func;
}


void* DialogSystem::get_interparsable_with_options_on_operational_chunk_func_user_data() const
{
   return interparsable_with_options_on_operational_chunk_func_user_data;
}
...
std::function<void(AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions*)> DialogSystem::get_interparsable_with_options_on_reveal_breakout_list_box() const
{
   return interparsable_with_options_on_reveal_breakout_list_box;
}


std::function<void(AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions*)> DialogSystem::get_interparsable_with_options_on_breakout_list_box_cursor_move() const
{
   return interparsable_with_options_on_breakout_list_box_cursor_move;
}


std::function<void(AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions*)> DialogSystem::get_interparsable_with_options_on_breakout_list_box_cursor_choose() const
{
   return interparsable_with_options_on_breakout_list_box_cursor_choose;
}
...
ALLEGRO_COLOR DialogSystem::get_standard_dialog_box_text_emphasis_color() const
{
...
void DialogSystem::set_bitmap_bin(AllegroFlare::BitmapBin* bitmap_bin)
{
   if (!((!initialized)))
   {
      ...
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::set_bitmap_bin]: error: guard \"(!initialized)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::set_bitmap_bin]: error: guard \"(!initialized)\" not met");
   }
...
void DialogSystem::set_font_bin(AllegroFlare::FontBin* font_bin)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::set_font_bin]: error: guard \"(!initialized)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::set_font_bin]: error: guard \"(!initialized)\" not met");
   }
...
void DialogSystem::set_event_emitter(AllegroFlare::EventEmitter* event_emitter)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::set_event_emitter]: error: guard \"(!initialized)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::set_event_emitter]: error: guard \"(!initialized)\" not met");
   }
...
void DialogSystem::load_dialog_node_bank_from_file(std::string filename)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::load_dialog_node_bank_from_file]: error: guard \"driver\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::load_dialog_node_bank_from_file]: error: guard \"driver\" not met");
   }
...
void DialogSystem::initialize()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::initialize]: error: guard \"(!initialized)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::initialize]: error: guard \"(!initialized)\" not met");
   }
   if (!(al_is_system_installed()))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::initialize]: error: guard \"al_is_system_installed()\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::initialize]: error: guard \"al_is_system_installed()\" not met");
   }
   if (!(al_is_primitives_addon_initialized()))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::initialize]: error: guard \"al_is_primitives_addon_initialized()\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::initialize]: error: guard \"al_is_primitives_addon_initialized()\" not met");
   }
   if (!(al_is_font_addon_initialized()))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::initialize]: error: guard \"al_is_font_addon_initialized()\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::initialize]: error: guard \"al_is_font_addon_initialized()\" not met");
   }
   if (!(bitmap_bin))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::initialize]: error: guard \"bitmap_bin\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::initialize]: error: guard \"bitmap_bin\" not met");
   }
   if (!(font_bin))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::initialize]: error: guard \"font_bin\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::initialize]: error: guard \"font_bin\" not met");
   }
   if (!(event_emitter))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::initialize]: error: guard \"event_emitter\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::initialize]: error: guard \"event_emitter\" not met");
   }
   initialized = true;
   return;
}
...
void DialogSystem::switch_in()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::switch_in]: error: guard \"(!switched_in)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::switch_in]: error: guard \"(!switched_in)\" not met");
   }
   switched_in = true;
...
void DialogSystem::switch_out()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::switch_out]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::switch_out]: error: guard \"initialized\" not met");
   }
   if (!(switched_in))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::switch_out]: error: guard \"switched_in\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::switch_out]: error: guard \"switched_in\" not met");
   }
   if (active_dialog_box)
   {
...
void DialogSystem::activate_EmitGameEvent_dialog_node(AllegroFlare::DialogTree::Nodes::EmitGameEvent* node)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::activate_EmitGameEvent_dialog_node]: error: guard \"node\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::activate_EmitGameEvent_dialog_node]: error: guard \"node\" not met");
   }
...
void DialogSystem::activate_RawScriptLine_dialog_node(AllegroFlare::DialogTree::Nodes::RawScriptLine* node)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::activate_RawScriptLine_dialog_node]: error: guard \"node\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::activate_RawScriptLine_dialog_node]: error: guard \"node\" not met");
   }
   active_dialog_node = node; // TODO: Test this line
...
void DialogSystem::activate_Wait_dialog_node(AllegroFlare::DialogTree::Nodes::Wait* node)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::activate_Wait_dialog_node]: error: guard \"node\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::activate_Wait_dialog_node]: error: guard \"node\" not met");
   }
...
void DialogSystem::activate_ChapterTitle_dialog_node(AllegroFlare::DialogTree::Nodes::ChapterTitle* node)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::activate_ChapterTitle_dialog_node]: error: guard \"node\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::activate_ChapterTitle_dialog_node]: error: guard \"node\" not met");
   }
   active_dialog_node = node;
...
void DialogSystem::activate_ExitDialog_dialog_node(AllegroFlare::DialogTree::Nodes::ExitDialog* node)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::activate_ExitDialog_dialog_node]: error: guard \"node\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::activate_ExitDialog_dialog_node]: error: guard \"node\" not met");
   }
...
void DialogSystem::activate_ExitProgram_dialog_node(AllegroFlare::DialogTree::Nodes::ExitProgram* node)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::activate_ExitProgram_dialog_node]: error: guard \"node\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::activate_ExitProgram_dialog_node]: error: guard \"node\" not met");
   }
   active_dialog_node = node;
...
void DialogSystem::activate_YouGotAnItemDialog_dialog_node(AllegroFlare::DialogTree::Nodes::YouGotAnItemDialog* node)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::activate_YouGotAnItemDialog_dialog_node]: error: guard \"node\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::activate_YouGotAnItemDialog_dialog_node]: error: guard \"node\" not met");
   }
   active_dialog_node = node;
...
void DialogSystem::activate_InterparsableWithOptions_dialog_node(AllegroFlare::DialogTree::Nodes::InterparsableWithOptions* node)
{
   if (!(node))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::activate_InterparsableWithOptions_dialog_node]: error: guard \"node\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::activate_InterparsableWithOptions_dialog_node]: error: guard \"node\" not met");
   }
   active_dialog_node = node;
   std::string speaker = node->get_speaker();
   std::vector<std::string> node_pages = node->get_pages();
...
void DialogSystem::activate_MultipageWithOptions_dialog_node(AllegroFlare::DialogTree::Nodes::MultipageWithOptions* node, std::string node_identifier)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::activate_MultipageWithOptions_dialog_node]: error: guard \"node\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::activate_MultipageWithOptions_dialog_node]: error: guard \"node\" not met");
   }
   active_dialog_node = node; // TODO: Test this line
...
void DialogSystem::activate_dialog_node(AllegroFlare::DialogTree::Nodes::Base* dialog_node)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::activate_dialog_node]: error: guard \"dialog_node\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::activate_dialog_node]: error: guard \"dialog_node\" not met");
   }
   ...
   else if (dialog_node->is_type(AllegroFlare::DialogTree::Nodes::InterparsableWithOptions::TYPE))
   {
      AllegroFlare::DialogTree::Nodes::InterparsableWithOptions *as =
         static_cast<AllegroFlare::DialogTree::Nodes::InterparsableWithOptions*>(dialog_node);
      activate_InterparsableWithOptions_dialog_node(as);
   }
...
void DialogSystem::advance_MultipageWithOptions_dialog_node(AllegroFlare::DialogTree::Nodes::MultipageWithOptions* node, int cursor_position)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::advance_MultipageWithOptions_dialog_node]: error: guard \"node\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::advance_MultipageWithOptions_dialog_node]: error: guard \"node\" not met");
   }
   if (!(node->has_options()))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::advance_MultipageWithOptions_dialog_node]: error: guard \"node->has_options()\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::advance_MultipageWithOptions_dialog_node]: error: guard \"node->has_options()\" not met");
   }
   if (!((cursor_position >= 0)))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::advance_MultipageWithOptions_dialog_node]: error: guard \"(cursor_position >= 0)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::advance_MultipageWithOptions_dialog_node]: error: guard \"(cursor_position >= 0)\" not met");
   }
   if (!((cursor_position < node->num_options())))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::advance_MultipageWithOptions_dialog_node]: error: guard \"(cursor_position < node->num_options())\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::advance_MultipageWithOptions_dialog_node]: error: guard \"(cursor_position < node->num_options())\" not met");
   }
   activate_dialog_option(cursor_position);
   return;
}

void DialogSystem::advance_InterparsableWithOptions_dialog_node(AllegroFlare::DialogTree::Nodes::InterparsableWithOptions* node, int cursor_position)
{
   if (!(node))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::advance_InterparsableWithOptions_dialog_node]: error: guard \"node\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::advance_InterparsableWithOptions_dialog_node]: error: guard \"node\" not met");
   }
   if (!(node->has_options()))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::advance_InterparsableWithOptions_dialog_node]: error: guard \"node->has_options()\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::advance_InterparsableWithOptions_dialog_node]: error: guard \"node->has_options()\" not met");
   }
   if (!((cursor_position >= 0)))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::advance_InterparsableWithOptions_dialog_node]: error: guard \"(cursor_position >= 0)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::advance_InterparsableWithOptions_dialog_node]: error: guard \"(cursor_position >= 0)\" not met");
   }
   if (!((cursor_position < node->num_options())))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::advance_InterparsableWithOptions_dialog_node]: error: guard \"(cursor_position < node->num_options())\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::advance_InterparsableWithOptions_dialog_node]: error: guard \"(cursor_position < node->num_options())\" not met");
   }
   activate_dialog_option(cursor_position);
   return;
}

void DialogSystem::advance_Interparsable_dialog_node(AllegroFlare::DialogTree::Nodes::Interparsable* node, int cursor_position)
{
   if (!(node))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::advance_Interparsable_dialog_node]: error: guard \"node\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::advance_Interparsable_dialog_node]: error: guard \"node\" not met");
   }
   if (!(node->has_options()))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::advance_Interparsable_dialog_node]: error: guard \"node->has_options()\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::advance_Interparsable_dialog_node]: error: guard \"node->has_options()\" not met");
   }
   if (!((cursor_position >= 0)))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::advance_Interparsable_dialog_node]: error: guard \"(cursor_position >= 0)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::advance_Interparsable_dialog_node]: error: guard \"(cursor_position >= 0)\" not met");
   }
   if (!((cursor_position < node->num_options())))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::advance_Interparsable_dialog_node]: error: guard \"(cursor_position < node->num_options())\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::advance_Interparsable_dialog_node]: error: guard \"(cursor_position < node->num_options())\" not met");
   }
   activate_dialog_option(cursor_position);
   return;
}
...
void DialogSystem::dialog_advance()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::dialog_advance]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::dialog_advance]: error: guard \"initialized\" not met");
   }
   if (!(active_dialog_box))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::dialog_advance]: error: guard \"active_dialog_box\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
   ...
   else if (active_dialog_node->is_type(AllegroFlare::DialogTree::Nodes::InterparsableWithOptions::TYPE))
   {
      //shutdown(); // DEVELOPMENT

      AllegroFlare::DialogTree::Nodes::InterparsableWithOptions *as =
         static_cast<AllegroFlare::DialogTree::Nodes::InterparsableWithOptions*>(active_dialog_node);
      ...
      if (as->num_options() == 1)
      {
         // If the dialog node has 1 option, "activate" it automatically
         int current_dialog_selection_choice = 0;
         advance_InterparsableWithOptions_dialog_node(as, current_dialog_selection_choice);
         //activate_dialog_option(current_dialog_selection_choice);
      }
      else
      {
         // If the dialog *node* has more than 1 option, correlate the dialog *box*'s current cursor position
            // with the result and "activate" it
         if (!active_dialog_box->is_type(AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions::TYPE))
         {
            throw std::runtime_error(
               "DialogSystem::dialog_advance: error: Expecting active_dialog_box (with more than one option) "
                  "to be of type \"AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions::TYPE\", but it is of type \""
                  + active_dialog_box->get_type() + "\""
            );
         }
         else
         {
            AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions *as_choice_dialog_box = 
               static_cast<AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions*>(active_dialog_box);
   ...
   {
      AllegroFlare::DialogTree::Nodes::Interparsable *as =
         static_cast<AllegroFlare::DialogTree::Nodes::Interparsable*>(active_dialog_node);
      ...
      else if (as->num_options() == 1)
      {
         // If the dialog node has 1 option, "activate" it automatically
         int current_dialog_selection_choice = 0;
         advance_Interparsable_dialog_node(as, current_dialog_selection_choice);
      }
      else // (as->num_options() > 1)
      {
         throw std::runtime_error(
            "DialogSystem::dialog_advance: error: Expecting 0 or 1 options for node named \""
               + active_dialog_node_name + "\" (which is of type Interparsable) but there are \""
               + std::to_string(as->num_options()) + "\" options."
         );
      }
   }
...
void DialogSystem::activate_dialog_option(int selection_choice)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::activate_dialog_option]: error: guard \"event_emitter\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::activate_dialog_option]: error: guard \"event_emitter\" not met");
   }
   if (!(active_dialog_node))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::activate_dialog_option]: error: guard \"active_dialog_node\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::activate_dialog_option]: error: guard \"active_dialog_node\" not met");
   }
   if (active_dialog_node->is_type(AllegroFlare::DialogTree::Nodes::InterparsableWithOptions::TYPE))
   {

      AllegroFlare::DialogTree::Nodes::InterparsableWithOptions *as_interparsable_with_options =
         static_cast<AllegroFlare::DialogTree::Nodes::InterparsableWithOptions*>(active_dialog_node);
      ...
      if (!(selection_choice < as_interparsable_with_options->num_options()))
      {
         throw std::runtime_error(
      ...
      AllegroFlare::DialogTree::NodeOptions::Base* node_option =
         std::get<1>(as_interparsable_with_options->get_option_num(selection_choice)); //.second;
   ...
   else if (active_dialog_node->is_type(AllegroFlare::DialogTree::Nodes::Interparsable::TYPE))
   {
      ...
      AllegroFlare::DialogTree::Nodes::Interparsable *as_interparsable =
         static_cast<AllegroFlare::DialogTree::Nodes::Interparsable*>(active_dialog_node);
      ...
      if (!(selection_choice < as_interparsable->num_options()))
      {
         throw std::runtime_error(
            "DialogSystem::activate_dialog_option: error: selection_choice must be less than the num options"
         );
      ...
      AllegroFlare::DialogTree::NodeOptions::Base* node_option =
         std::get<1>(as_interparsable->get_option_num(selection_choice)); //.second;
      std::string node_option_type = node_option->get_type();
...
void DialogSystem::spawn_choice_dialog(std::string speaking_character, std::string prompt, std::vector<std::string> options, int cursor_position_on_spawn)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::spawn_choice_dialog]: error: guard \"(cursor_position_on_spawn >= 0)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::spawn_choice_dialog]: error: guard \"(cursor_position_on_spawn >= 0)\" not met");
   }
   if (!((cursor_position_on_spawn < options.size())))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::spawn_choice_dialog]: error: guard \"(cursor_position_on_spawn < options.size())\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::spawn_choice_dialog]: error: guard \"(cursor_position_on_spawn < options.size())\" not met");
   }
   switch_in_if_not();
...
void DialogSystem::update(float time_now)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::update]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::update]: error: guard \"initialized\" not met");
   }
...
void DialogSystem::render()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::render]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::render]: error: guard \"initialized\" not met");
   }
   if (!(driver))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::render]: error: guard \"driver\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::render]: error: guard \"driver\" not met");
   }
   ...
   if (active_dialog_box)
   {
      ...
      dialog_box_renderer.set_standard_dialog_box_text_emphasis_color(standard_dialog_box_text_emphasis_color);
...
bool DialogSystem::dialog_is_finished()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::dialog_is_finished]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::dialog_is_finished]: error: guard \"initialized\" not met");
   }
   if (!(active_dialog_box))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::dialog_is_finished]: error: guard \"active_dialog_box\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::dialog_is_finished]: error: guard \"active_dialog_box\" not met");
   }
...
bool DialogSystem::shutdown()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::shutdown]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::shutdown]: error: guard \"initialized\" not met");
   }
   if (!(driver))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::shutdown]: error: guard \"driver\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::shutdown]: error: guard \"driver\" not met");
   }
   if (!(switched_in))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::shutdown]: error: guard \"switched_in\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::shutdown]: error: guard \"switched_in\" not met");
   }
   switch_out();
   return true;
}
...
void DialogSystem::move_dialog_cursor_position_up()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::move_dialog_cursor_position_up]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::move_dialog_cursor_position_up]: error: guard \"initialized\" not met");
   }
...
void DialogSystem::move_dialog_cursor_position_down()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::move_dialog_cursor_position_down]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::move_dialog_cursor_position_down]: error: guard \"initialized\" not met");
   }
   if (!active_dialog_box) return;
...
void DialogSystem::handle_raw_ALLEGRO_EVENT_that_is_dialog_event(ALLEGRO_EVENT* ev, AllegroFlare::GameEventDatas::Base* data)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::handle_raw_ALLEGRO_EVENT_that_is_dialog_event]: error: guard \"ev\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::handle_raw_ALLEGRO_EVENT_that_is_dialog_event]: error: guard \"ev\" not met");
   }
   if (!(data))
   {
      std::stringstream error_message;
      error_message << "[AllegroFlare::DialogSystem::DialogSystem::handle_raw_ALLEGRO_EVENT_that_is_dialog_event]: error: guard \"data\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[AllegroFlare::DialogSystem::DialogSystem::handle_raw_ALLEGRO_EVENT_that_is_dialog_event]: error: guard \"data\" not met");
   }
