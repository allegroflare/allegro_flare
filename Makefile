...
CORE_ITEMS=appearance2d attributes automation bitmap_object blender camera2d camera3d color config cubemap data_attr decorated_cout display drawing_interface file_path file_path_object framework frustum generate_textures grid2d image_processing md5 model motion render_cache render_music_notation object2d path2d placement2d placement3d profile_timer programming_language render_sample screen sha2 shader skeleton sound_object text_object timeline useful
