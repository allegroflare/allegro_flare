...
namespace AllegroFlare
{
   namespace DialogTree
   {
      namespace Nodes
      {
         class InterparsableWithOptions : public AllegroFlare::DialogTree::Nodes::Base
         {
         public:
            static constexpr char* TYPE = (char*)"AllegroFlare/DialogTree/Nodes/InterparsableWithOptions";
         ...
         public:
            InterparsableWithOptions(std::string speaker="[unset-speaker]", std::vector<std::string> pages={"[unset-pages]"}, std::vector<std::tuple<std::string, AllegroFlare::DialogTree::NodeOptions::Base*, AllegroFlare::BitFlags<uint32_t>>> options={});
