...
namespace AllegroFlare
{
   ...
   public:
      ...
      bool get_right_button_pressed();
      bool get_left_button_pressed();
      bool get_up_button_pressed();
      bool get_down_button_pressed();
      bool get_a_button_pressed();
      bool get_b_button_pressed();
      bool get_x_button_pressed();
      bool get_y_button_pressed();
      bool get_left_bumper_pressed();
      bool get_right_bumper_pressed();
      bool get_start_button_pressed();
      AllegroFlare::vec2d get_primary_stick_position();
      AllegroFlare::vec2d get_secondary_stick_position();
      void clear();
   };
}
