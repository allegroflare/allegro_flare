...
namespace AllegroFlare
{
   namespace DialogSystem
   {
      ...
      private:
         ...
         std::function<bool(AllegroFlare::DialogSystem::DialogSystem*, AllegroFlare::Elements::DialogBoxes::Base*, AllegroFlare::DialogTree::Nodes::Base*, void*)> handle_raw_script_line_finished_func;
         void* handle_raw_script_line_finished_func_user_data;
         bool switched_in;
      ...
      public:
         ...
         void set_handle_raw_script_line_finished_func(std::function<bool(AllegroFlare::DialogSystem::DialogSystem*, AllegroFlare::Elements::DialogBoxes::Base*, AllegroFlare::DialogTree::Nodes::Base*, void*)> handle_raw_script_line_finished_func);
         void set_handle_raw_script_line_finished_func_user_data(void* handle_raw_script_line_finished_func_user_data);
         ...
         std::function<bool(AllegroFlare::DialogSystem::DialogSystem*, AllegroFlare::Elements::DialogBoxes::Base*, AllegroFlare::DialogTree::Nodes::Base*, void*)> get_handle_raw_script_line_finished_func() const;
         void* get_handle_raw_script_line_finished_func_user_data() const;
         ...
         bool __new_on_activate_dialog_node_by_name(std::string active_dialog_node_name="[unset-dialog_node_identifier]", AllegroFlare::DialogTree::Nodes::Base* active_dialog_node=nullptr, void* user_data=nullptr);
      };
   }
}
