...
namespace AllegroFlare
{
   namespace Runners
   {
      ...
      private:
         ...
         int current_manual_save_slot_position;
      ...
      public:
         ...
         int get_current_manual_save_slot_position();
         void set_current_manual_save_slot_position(int current_manual_save_slot_position=1);
