...
namespace AllegroFlare
{
   namespace Elements
   {
      ...
      public:
         ...
         AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions* create_interparsable_with_options_dialog(std::string speaking_character="[unset-speaking_character]", std::vector<std::string> pages={}, std::function<void(std::string, AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions*, void*)> interparsable_on_operational_chunk_func={}, void* interparsable_on_operational_chunk_func_user_data=nullptr);
