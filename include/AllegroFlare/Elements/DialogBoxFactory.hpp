...
namespace AllegroFlare
{
   namespace Elements
   {
      ...
      public:
         ...
         AllegroFlare::Elements::DialogBoxes::YouGotAnItem* create_you_got_new_evidence_dialog(std::string evidence_name="[unset-evidence_name]", std::string evidence_bitmap_identifier="[unset-evidence_bitmap_identifier]");
      };
   }
}
