...
namespace AllegroFlare
{
   namespace Elements
   {
      namespace RollingCredits
      {
         namespace Sections
         {
            class LegalText : public AllegroFlare::Elements::RollingCredits::Sections::Base
            {
            public:
               ...
               static constexpr char* TYPE = (char*)"Sections/LegalText";
            ...
            public:
               LegalText(std::string text="[unset-text]", std::string alignment=ALIGN_LEFT);
               ~LegalText();
