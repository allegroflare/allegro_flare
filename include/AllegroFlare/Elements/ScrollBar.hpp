...
namespace AllegroFlare
{
   namespace Elements
   {
      ...
      public:
         ScrollBar(float x=0.0f, float y=0.0f, float height=100.0f, float handle_height=50.0f, float position=0.0f, float rail_thickness=8.0f, float handle_thickness=16.0f);
         ~ScrollBar();
