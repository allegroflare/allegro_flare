...
namespace AllegroFlare
{
   namespace Elements
   {
      ...
      public:
         InputDevicesList(AllegroFlare::FontBin* font_bin=nullptr, std::vector<std::tuple<AllegroFlare::PhysicalInputDevices::Base*, uint32_t, std::string, std::string>> input_devices={}, float input_devices_box_width=1140.0f, float input_devices_box_height=160.0f);
         ~InputDevicesList();
