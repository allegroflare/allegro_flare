...
namespace AllegroFlare
{
   namespace Elements
   {
      ...
      private:
         ...
         std::vector<std::tuple<std::string, std::string, std::string>> input_devices;
         ...
         float box_gutter_y;
         int count_num_input_devices_completed();
      ...
      public:
         InputDevicesList(AllegroFlare::FontBin* font_bin=nullptr, std::vector<std::tuple<std::string, std::string, std::string>> input_devices={}, float input_devices_box_width=940.0f, float input_devices_box_height=130.0f);
         ~InputDevicesList();

         void set_font_bin(AllegroFlare::FontBin* font_bin);
         void set_input_devices(std::vector<std::tuple<std::string, std::string, std::string>> input_devices);
         ...
         std::vector<std::tuple<std::string, std::string, std::string>> get_input_devices() const;
         ...
         static std::vector<std::tuple<std::string, std::string, std::string>> build_placeholder_input_devices();
      };
   }
}
