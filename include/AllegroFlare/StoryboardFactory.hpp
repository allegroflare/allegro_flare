...
namespace AllegroFlare
{
   ...
   public:
      ...
      AllegroFlare::Screens::Storyboard* create_images_storyboard_screen(AllegroFlare::EventEmitter* event_emitter=nullptr, int button_font_size=-40, std::vector<ALLEGRO_BITMAP*> source_bitmaps={});
