...
namespace AllegroFlare
{
   ...
   public:
      ...
      AllegroFlare::Screens::Storyboard* create_advancing_text_storyboard_screen(std::vector<std::string> pages_text={}, int button_font_size=-40, float page_top_padding=400, float page_left_padding=400, float page_right_padding=400, int page_text_font_size=-40, float page_text_line_height_multiplier=1.5);
   };
}
