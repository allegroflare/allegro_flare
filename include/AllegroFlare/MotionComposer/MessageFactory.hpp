...
namespace AllegroFlare
{
   namespace MotionComposer
   {
      ...
      public:
         ...
         std::string build_run_build_process_message_json(std::string platform="[unset-platform]", std::string source_release_zip_url="[unset-source_release_zip_url]", std::string name_of_source_release_folder="[unset-name_of_source_release_folder]");
