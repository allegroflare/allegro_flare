      ...
      namespace Platforming2D
      {
         namespace Entities
         {
            ...
            public:
               ...
               std::vector<AllegroFlare::Prototypes::Platforming2D::Entities::Basic2D*> create_entities_from_map(std::string map_tmj_filename="[unset-map_tmj_filename]", std::string map_name="[unset-map_name]", std::function<void( std::string, float, float, float, float, int, std::string, std::string, AllegroFlare::Prototypes::Platforming2D::TMJObjectLoaderObjectCustomProperties, std::vector<AllegroFlare::Prototypes::Platforming2D::Entities::Basic2D*>*, AllegroFlare::Prototypes::Platforming2D::Entities::Basic2DFactory*, void*) > callback={}, void* callback_data=nullptr);
            };
         }
      }
   }
