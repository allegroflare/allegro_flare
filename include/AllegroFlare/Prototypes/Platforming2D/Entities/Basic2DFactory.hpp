      ...
      namespace Platforming2D
      {
         namespace Entities
         {
            ...
            public:
               ...
               static void create_entities_from_map__tmj_obj_loader_callback_func(std::string object_class="[unset-object_class]", float x=0.0f, float y=0.0f, float width=0.0f, float height=0.0f, void* data=nullptr);
