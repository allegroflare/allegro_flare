      ...
      namespace Platforming2D
      {
         namespace Entities
         {
            ...
            public:
               ...
               static void create_entities_from_map__tmj_obj_loader_callback_func(std::string object_type="[unset-object_type]", float x=0.0f, float y=0.0f, float width=0.0f, float height=0.0f, int id=0, AllegroFlare::Prototypes::Platforming2D::TMJObjectLoaderObjectCustomProperties custom_properties={}, void* data=nullptr);
               static void create_entities_from_map__tmj_obj_loader_with_callback_provided_func(std::string object_type="[unset-object_type]", float x=0.0f, float y=0.0f, float width=0.0f, float height=0.0f, int id=0, AllegroFlare::Prototypes::Platforming2D::TMJObjectLoaderObjectCustomProperties custom_properties={}, void* data=nullptr);
               std::vector<AllegroFlare::Prototypes::Platforming2D::Entities::Basic2D*> create_entities_from_map(std::string map_tmj_filename="[unset-map_tmj_filename]", std::string map_name="[unset-map_name]", std::function<void( std::string, float, float, float, float, int, AllegroFlare::Prototypes::Platforming2D::TMJObjectLoaderObjectCustomProperties, std::vector<AllegroFlare::Prototypes::Platforming2D::Entities::Basic2D*>*, AllegroFlare::Prototypes::Platforming2D::Entities::Basic2DFactory*, void*) > callback={}, void* callback_data=nullptr);
            };
         }
      }
   }
