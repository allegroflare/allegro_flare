...
namespace AllegroFlare
{
   namespace Physics
   {
      class CollisionMeshCollisionStepper2
      {
      public:
      ...
      public:
         CollisionMeshCollisionStepper2(std::vector<AllegroFlare::Physics::CollisionMesh*> collision_meshes={}, std::vector<std::tuple<AllegroFlare::Vec3D*, AllegroFlare::Vec3D*, void*>>* _entities=nullptr, float face_collision_stepout=0.001f);
         ~CollisionMeshCollisionStepper2();
         ...
         void set_stepout_strategy(AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy stepout_strategy);
         void set_redirect_strategy(AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy redirect_strategy);
         ...
         AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy get_stepout_strategy() const;
         AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy get_redirect_strategy() const;
         ...
         static std::string to_string(AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy stepout_strategy=StepoutStrategy::STEPOUT_UNDEF);
         static std::string to_string(AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy redirect_strategy=RedirectStrategy::REDIRECT_UNDEF);
