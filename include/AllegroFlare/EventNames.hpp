...
#define ALLEGRO_FLARE_EVENT_PAUSE_GAMEPLAY              ALLEGRO_GET_EVENT_TYPE('F','P','w','s')
#define ALLEGRO_FLARE_EVENT_UNPAUSE_GAMEPLAY            ALLEGRO_GET_EVENT_TYPE('F','U','n','p')
...
#define ALLEGRO_FLARE_EVENT_SET_DISPLAY_SIZE            ALLEGRO_GET_EVENT_TYPE('F','S','D','S')
...
#define ALLEGRO_FLARE_EVENT_POST_ACHIEVEMENT_UNLOCKED_NOTIFICATION  ALLEGRO_GET_EVENT_TYPE('F','P','A','u')
#define ALLEGRO_FLARE_EVENT_POST_JOYSTICK_CONNECTED_NOTIFICATION    ALLEGRO_GET_EVENT_TYPE('F','P','J','C')
#define ALLEGRO_FLARE_EVENT_POST_JOYSTICK_DISCONNECTED_NOTIFICATION ALLEGRO_GET_EVENT_TYPE('F','P','J','D')
