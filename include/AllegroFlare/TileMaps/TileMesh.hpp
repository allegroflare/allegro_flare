...
namespace AllegroFlare
{
   namespace TileMaps
   {
      ...
      private:
         ...
         std::set<std::pair<int, int>> removed_tiles;
         int num_columns;
         int num_rows;
         int tile_width;
         int tile_height;
         ...
         bool holding_index_buffer_update_until_refresh;
      ...
      public:
         ...
         std::set<std::pair<int, int>> get_removed_tiles() const;
         ...
         bool get_holding_index_buffer_update_until_refresh() const;
         bool get_index_buffer_is_dirty() const;
         ...
         std::vector<int> assemble_vertices_to_remove_from_removed_tiles();
