      ...
      namespace AutoTile
      {
         namespace Filters
         {
            ...
            public:
               ...
               void iterate_through_input_and_apply_to_result_if_match(std::vector<std::vector<int>> match_matrix={}, std::vector<std::vector<int>> apply_matrix={}, int match_matrix_offset_x=0, int match_matrix_offset_y=0, int apply_matrix_offset_x=0, int apply_matrix_offset_y=0, std::string out_of_bounds_match_type=OUT_OF_BOUNDS_MATCH_TYPE_POSITIVE, bool ignore_if_negative_tile_value_on_match_matrix=true, bool ignore_write_if_negative_tile_value_on_stamp_tile=true, bool ignore_if_stamp_tile_is_out_of_bounds_on_result_matrix=true);
