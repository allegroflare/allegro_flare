...
namespace AllegroFlare
{
   namespace Story
   {
      namespace Characters
      {
         ...
         public:
            PersonalityDimension(std::string name="[unset-name]", std::string description="[unset-description]", std::string descriptor_very_low="[unset-descriptor_very_low]", std::string descriptor_low="[unset-descriptor_low]", std::string descriptor_medium="[unset-descriptor_medium]", std::string descriptor_high="[unset-descriptor_high]", std::string descriptor_very_high="[unset-descriptor_very_high]");
