...
namespace AllegroFlare
{
   ...
   public:
      ...
      std::vector<AllegroFlare::PhysicalInputDevices::Base*> get_joysticks_connected_after_last_reconfiguration();
      std::vector<AllegroFlare::PhysicalInputDevices::Base*> get_joysticks_disconnected_after_last_reconfiguration();
