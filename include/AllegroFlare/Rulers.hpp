...
namespace AllegroFlare
{
   ...
   public:
      ...
      static void draw_hd_layout_grid(float x=(1920/2.0f), float y=(1080/2.0f), int num_sections_x=10, int num_sections_y=6, ALLEGRO_COLOR color=ALLEGRO_COLOR{0.5, 0.5, 0.5, 0.5}, float line_thickness=1.0f, float dot_spacing=10.0f, float dot_length=10.0f);
