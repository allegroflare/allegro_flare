...
public:
   TileMapVertexBufferRenderer(AllegroFlare::TileMaps::PrimMeshAtlas &atlas);
   ...
   bool set_tile(AllegroFlare::TileMaps::PrimMeshAtlas &atlas, int tile_x, int tile_y, int tile_index);
