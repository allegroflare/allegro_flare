...
class AllegroFlare_MultitextureModel3DTest : public ::testing::Test {};
class AllegroFlare_MultitextureModel3DWithAllegroRenderingFixtureTest : public AllegroFlare::Testing::WithAllegroRenderingFixture
{
public:
...
TEST_F(AllegroFlare_MultitextureModel3DTest, can_be_created_without_blowing_up)
{
   AllegroFlare::MultitextureModel3D model_3d;
}


TEST_F(AllegroFlare_MultitextureModel3DTest,
   ...
   extract_named_object_vertices__when_a_named_object_does_not_exist_with_that_name__throws_an_error)
{
   ...
   EXPECT_THROW_WITH_MESSAGE(
      ...
      std::runtime_error,
      "[AllegroFlare::MultitextureModel3D::extract_named_object_vertices] error: Looking for named_object named "
