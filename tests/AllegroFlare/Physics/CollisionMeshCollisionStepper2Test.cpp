...
class AllegroFlare_Physics_CollisionMeshCollisionStepper2Test : public ::testing::Test {};
class AllegroFlare_Physics_CollisionMeshCollisionStepper2TestWithAllegroRenderingFixture
   : public AllegroFlare::Testing::WithAllegroRenderingFixture
{};
class AllegroFlare_Physics_CollisionMeshCollisionStepper2TestWithInteractionFixture
...
public:
   ...
   AllegroFlare_Physics_CollisionMeshCollisionStepper2TestWithInteractionFixture()
      ...
      , hud_camera()
      , live_camera()
      , air_drag(AllegroFlare::Physics::CollisionMeshCollisionStepper2::DEFAULT_AIR_DRAG)
      , gravity(AllegroFlare::Physics::CollisionMeshCollisionStepper2::DEFAULT_GRAVITY)
      ...
      while(interactive_test_wait_for_event())
      {
         ...
         switch(current_event.type)
         {
            case ALLEGRO_EVENT_TIMER:
            {
               ...
               AllegroFlare::Physics::CollisionMeshCollisionStepper2 stepper;
               ...
               //stepper.set_redirect_strategy(
                  //AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy::REDIRECT_REFLECT_SURFACE
               //);
               stepper.step();
...
TEST_F(AllegroFlare_Physics_CollisionMeshCollisionStepper2Test, can_be_created_without_blowing_up)
{
   AllegroFlare::Physics::CollisionMeshCollisionStepper2 collision_mesh3dcollision_stepper;
}
...
void create_response_diagram(
   ...
   AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy stepout_strategy =
...
)
{
   ...
   AllegroFlare::Physics::CollisionMeshCollisionStepper2::move_to_time_of_collision_and_react_to_collision(
      ...
      stepout_strategy,
      redirect_strategy
      //AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy::STEPOUT_DIRECTLY_UP,
      //AllegroFlare::Physics::CollisionMeshCollisionStepper2::StepoutStrategy::STEPOUT_REVERSE_VELOCITY,
      //AllegroFlare::Physics::CollisionMeshCollisionStepper2::STEPOUT_REFLECT_SURFACE
      //AllegroFlare::Physics::CollisionMeshCollisionStepper2::STEPOUT_EXTRUDE_FACE_NORMAL
      //AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy::REDIRECT_DIRECTLY_UP
      //AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy::REDIRECT_STOP_VERTICAL
      //AllegroFlare::Physics::CollisionMeshCollisionStepper2::RedirectStrategy::REDIRECT_SLIDE_ALONG_SURFACE
   );
   ...
   al_draw_multiline_textf(
      ...
      face_normal.z,
      face_collision_stepout,
      AllegroFlare::Physics::CollisionMeshCollisionStepper2::to_string(stepout_strategy).c_str(),
      AllegroFlare::Physics::CollisionMeshCollisionStepper2::to_string(redirect_strategy).c_str(),
...
TEST_F(AllegroFlare_Physics_CollisionMeshCollisionStepper2TestWithAllegroRenderingFixture,
...
TEST_F(AllegroFlare_Physics_CollisionMeshCollisionStepper2TestWithInteractionFixture,
