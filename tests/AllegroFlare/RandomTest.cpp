...
TEST(RandomTest, gets_the_current_seed)
{
...
TEST(RandomTest, sets_the_current_seed)
{
   Random number_generator = Random(123);
...
TEST(RandomTest, only_returns_integers_within_the_bounds_inclusive)
{
   Random number_generator = Random(123);
...
TEST(RandomTest, only_returns_doubles_within_the_bounds_inclusive)
{
   Random number_generator = Random(123);
...
TEST(RandomTest, only_returns_floats_within_the_bounds_inclusive)
{
   Random number_generator = Random(123);
