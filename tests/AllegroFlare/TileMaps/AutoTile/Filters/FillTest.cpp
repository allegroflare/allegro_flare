...
TEST(AllegroFlare_TileMaps_AutoTile_Filters_FillTest, can_be_created_without_blowing_up)
{
   AllegroFlare::TileMaps::AutoTile::Filters::Fill basic;
}


TEST(AllegroFlare_TileMaps_AutoTile_Filters_FillTest, TYPE__has_the_expected_value)
{
   AllegroFlare::TileMaps::AutoTile::Filters::Fill basic;
   EXPECT_EQ("Filters/Fill", basic.get_type());
}


TEST(AllegroFlare_TileMaps_AutoTile_Filters_FillTest, type__has_the_expected_value_matching_TYPE)
{
   AllegroFlare::TileMaps::AutoTile::Filters::Fill basic;
   EXPECT_EQ(AllegroFlare::TileMaps::AutoTile::Filters::Fill::TYPE, basic.get_type());
}


TEST(AllegroFlare_TileMaps_AutoTile_Filters_FillTest,
   result_matrix__after_process__will_have_the_same_width_and_height_as_the_input_matrix)
{
   AllegroFlare::TileMaps::AutoTile::Filters::Fill basic_filter;
...
{
   AllegroFlare::TileMaps::AutoTile::Filters::Fill basic_filter(7);
