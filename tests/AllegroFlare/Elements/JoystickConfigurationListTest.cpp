...
#include <AllegroFlare/PhysicalInputDevices/GenericJoystick.hpp> // TODO: replace this usage with an in-test defined
...
{
   AllegroFlare::PhysicalInputDevices::GenericJoystick generic_joystick_physical_input_device;
   AllegroFlare::Elements::JoystickConfigurationList achievements(&get_font_bin_ref());
