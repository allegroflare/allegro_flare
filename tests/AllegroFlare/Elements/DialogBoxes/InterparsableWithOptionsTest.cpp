...
TEST(AllegroFlare_Elements_DialogBoxes_InterparsableWithOptionsTest, can_be_created_without_blowing_up)
{
   AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions interparsable;
}

TEST(AllegroFlare_Elements_DialogBoxes_InterparsableWithOptionsTest, get_type__returns_the_expected_value)
{
   AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions interparsable;
   EXPECT_EQ("AllegroFlare/Elements/DialogBoxes/InterparsableWithOptions", interparsable.get_type());
}


TEST(AllegroFlare_Elements_DialogBoxes_InterparsableWithOptionsTest, set_pages__sets_the_pages_with_the_passed_value)
{
...
TEST(AllegroFlare_Elements_DialogBoxes_InterparsableWithOptionsTest, next_page__will_increment_the_page_number)
{
   al_init();
   std::vector<std::string> pages = {
      "Page 1 has this test",
...
TEST(AllegroFlare_Elements_DialogBoxes_InterparsableWithOptionsTest, update__when_the_current_page_contains_only_\
...
TEST(AllegroFlare_Elements_DialogBoxes_InterparsableWithOptionsTest, next_page__when_the_next_page_contains_only_\
operational_text__will_automatically_advance_to_the_page_after)
{
   al_init();
   std::vector<std::string> pages = {
...
TEST(AllegroFlare_Elements_DialogBoxes_InterparsableWithOptionsTest, next_page__when_at_the_last_page_that_contains_only_\
...
TEST(AllegroFlare_Elements_DialogBoxes_InterparsableWithOptionsTest, has_no_pages__will_true_if_there_are_no_pages)
{
   AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions dialog_box;
...
TEST(AllegroFlare_Elements_DialogBoxes_InterparsableWithOptionsTest, next_page__will_increment_the_page_text)
{
   al_init();
   std::vector<std::string> pages = {
      "Page 1 has this test",
...
TEST(AllegroFlare_Elements_DialogBoxes_InterparsableWithOptionsTest, parse_into_chunks__will_generate_the_expected_chunks)
{
   ...
   std::vector<std::pair<bool, std::string>> actual_chunks =
      AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions::parse_into_chunks(raw_text_source);
...
operational_chunks_removed)
{
   ...
   std::string actual_processed_text = 
      AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions::collate_printable_text_only(raw_text_source);
...
throw_an_error)
{
   ...
   EXPECT_THROW_WITH_MESSAGE(
      AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions::parse_into_chunks(raw_text_source),
      std::runtime_error,
      "[AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions::parse_into_chunks]: error: Unmatched opening parenthesis "
...
throw_an_error)
{
   ...
   EXPECT_THROW_WITH_MESSAGE(
      AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions::parse_into_chunks(raw_text_source),
      std::runtime_error,
      "[AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions::parse_into_chunks]: error: Nested parentheses were "
...
an_opening_paren__will_throw_an_error)
{
   ...
   EXPECT_THROW_WITH_MESSAGE(
      AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions::parse_into_chunks(raw_text_source),
      std::runtime_error,
      "[AllegroFlare::Elements::DialogBoxes::InterparsableWithOptions::parse_into_chunks]: error: There was an open paren that "
