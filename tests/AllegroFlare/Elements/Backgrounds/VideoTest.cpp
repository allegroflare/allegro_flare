...
class AllegroFlare_Elements_Backgrounds_VideoTest : public ::testing::Test
{};
...
TEST_F(AllegroFlare_Elements_Backgrounds_VideoTest, can_be_created_without_blowing_up)
{
   AllegroFlare::Elements::Backgrounds::Video video_background;
}


TEST_F(AllegroFlare_Elements_Backgrounds_VideoTest, TYPE__has_the_expected_value)
{
   EXPECT_EQ(
      "AllegroFlare/Elements/Backgrounds/Video",
      AllegroFlare::Elements::Backgrounds::Video::TYPE
   );
}


TEST_F(AllegroFlare_Elements_Backgrounds_VideoTest, type__has_the_expected_value_matching_TYPE)
{
   AllegroFlare::Elements::Backgrounds::Video video_background;
   EXPECT_EQ(AllegroFlare::Elements::Backgrounds::Video::TYPE, video_background.get_type());
}
...
TEST_F(AllegroFlare_Elements_Backgrounds_VideoTestWithAllegroRenderingFixture, render__will_render_the_video)
{
   ...
   AllegroFlare::Elements::Backgrounds::Video video_background(&video_bin, video_identifier);
   video_background.initialize();

   video_background.activate();

   int num_frames = 30;
   for (int i=0; i<num_frames; i++)
   {
      video_background.render();
      al_flip_display();
      sleep_for_frame();
   }
