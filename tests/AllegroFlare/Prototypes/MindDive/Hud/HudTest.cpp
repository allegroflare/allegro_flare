...
TEST_F(AllegroFlare_Prototypes_MindDive_Hud_HudTest, render__without_allegro_initialized__raises_an_error)
{
   AllegroFlare::Prototypes::MindDive::Hud::Hud hud;
...
TEST_F(AllegroFlare_Prototypes_MindDive_Hud_HudTest, render__without_primitives_addon_initialized__raises_an_error)
{
   al_init();
   AllegroFlare::Prototypes::MindDive::Hud::Hud hud;
   std::string expected_error_message =
      "Hud::render: error: guard \"al_is_primitives_addon_initialized()\" not met";
   EXPECT_THROW_WITH_MESSAGE(hud.render(), std::runtime_error, expected_error_message);
   al_uninstall_system();
}


TEST_F(AllegroFlare_Prototypes_MindDive_Hud_HudTest, render__without_font_addon_initialized__raises_an_error)
{
   al_init();
   al_init_primitives_addon();
   AllegroFlare::Prototypes::MindDive::Hud::Hud hud;
   std::string expected_error_message =
      "Hud::render: error: guard \"al_is_font_addon_initialized()\" not met";
   EXPECT_THROW_WITH_MESSAGE(hud.render(), std::runtime_error, expected_error_message);
...
TEST_F(AllegroFlare_Prototypes_MindDive_Hud_HudTest, render__without_a_font_bin__raises_an_error)
{
   al_init();
   al_init_primitives_addon();
   al_init_font_addon();
   AllegroFlare::Prototypes::MindDive::Hud::Hud hud;
   std::string expected_error_message =
      "Hud::render: error: guard \"font_bin\" not met";
   EXPECT_THROW_WITH_MESSAGE(hud.render(), std::runtime_error, expected_error_message);
