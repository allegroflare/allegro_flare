...
TEST(AllegroFlare_Prototypes_Platforming2D_Entities_MovementStrategies2D_BackAndForthHorizontalTest, can_be_created_without_blowing_up)
{
   AllegroFlare::Prototypes::Platforming2D::Entities::MovementStrategies2D::BackAndForthHorizontal strategy;
}


TEST(AllegroFlare_Prototypes_Platforming2D_Entities_MovementStrategies2D_BackAndForthHorizontalTest, update__without_an_entity__throws_an_error)
{
   AllegroFlare::Prototypes::Platforming2D::Entities::MovementStrategies2D::BackAndForthHorizontal strategy;
...
TEST(AllegroFlare_Prototypes_Platforming2D_Entities_MovementStrategies2D_BackAndForthHorizontalTest, update__will_not_blow_up)
{
   AllegroFlare::Prototypes::Platforming2D::Entities::Basic2D basic2d_entity;
   AllegroFlare::Prototypes::Platforming2D::Entities::MovementStrategies2D::BackAndForthHorizontal strategy(&basic2d_entity);
   strategy.update();
}
   ...
   update__will_assign_the_entitys_left_velocity_to_the_travel_speed)
{
   ...
   AllegroFlare::Prototypes::Platforming2D::Entities::Basic2D basic2d_entity;
   AllegroFlare::Prototypes::Platforming2D::Entities::MovementStrategies2D::BackAndForthHorizontal strategy(&basic2d_entity, travel_speed);
...
TEST(AllegroFlare_Prototypes_Platforming2D_Entities_MovementStrategies2D_BackAndForthHorizontalTest, travel_speed__has_the_expected_default_value)
{
   AllegroFlare::Prototypes::Platforming2D::Entities::MovementStrategies2D::BackAndForthHorizontal strategy;
