   ...
   update__without_an_entity__throws_an_error)
{
   ...
   EXPECT_THROW_GUARD_ERROR(
      strategy.update(),
      "AllegroFlare::Prototypes::Platforming2D::Entities::MovementStrategies2D::Tracking::update",
      "entity"
   );
}
...
TEST(AllegroFlare_Prototypes_Platforming2D_Entities_MovementStrategies2D_TrackingTest,
   update__without_a_tracked_entity__throws_an_error)
{
