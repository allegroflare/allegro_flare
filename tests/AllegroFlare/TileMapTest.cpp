...
TEST(AllegroFlare_TileMapTest, num_columns__has_the_expected_default_value)
{
   AllegroFlare::TileMap<int> tile_map;
...
TEST(AllegroFlare_TileMapTest, resize__will_set_the_width_and_num_columns)
{
   // TODO
}
...
TEST(AllegroFlare_TileMapTest, is_dimensionless__if_the_width_or_num_columns_is_less_than_or_equal_zero__returns_true)
{
   AllegroFlare::TileMap<int> tile_map;
...
TEST(AllegroFlare_TileMapTest, is_dimensionless__if_the_width_or_num_columns_are_positive_numbers__returns_false)
{
   AllegroFlare::TileMap<int> tile_map(4, 3);
