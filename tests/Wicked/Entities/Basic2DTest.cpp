...
class Wicked_Entities_Basic2DTest : public ::testing::Test {};
class Wicked_Entities_Basic2DWithAllegroRenderingFixtureTest
...
TEST_F(Wicked_Entities_Basic2DTest, update__can_be_called_without_blowing_up)
{
   Wicked::Entities::Basic2D basic2d_entity;
...
TEST_F(Wicked_Entities_Basic2DTest,
...
TEST_F(Wicked_Entities_Basic2DWithAllegroRenderingFixtureTest, draw__can_be_called_without_blowing_up)
{
...
TEST_F(Wicked_Entities_Basic2DWithAllegroRenderingFixtureTest, draw__with_a_modified_place__will_display_the_image)
{
