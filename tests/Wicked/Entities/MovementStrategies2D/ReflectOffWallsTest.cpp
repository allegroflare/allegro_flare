...
TEST(Wicked_Entities_MovementStrategies2D_ReflectOffWallsTest, update__will_not_blow_up)
{
   Wicked::Entities::Basic2D basic2d_entity;
   Wicked::Entities::MovementStrategies2D::ReflectOffWalls strategy(&basic2d_entity);
   strategy.update();
}


TEST(Wicked_Entities_MovementStrategies2D_ReflectOffWallsTest, update__will_assign_the_entitys_left_velocity_to_the_speed)
{
   //TODO: (also rename method)
   //float speed = 7.3f;
   //Wicked::Entities::Basic2D basic2d_entity;
   //Wicked::Entities::MovementStrategies2D::ReflectOffWalls strategy(&basic2d_entity, speed);
...
TEST(Wicked_Entities_MovementStrategies2D_ReflectOffWallsTest, speed__has_the_expected_default_value)
{
   Wicked::Entities::MovementStrategies2D::ReflectOffWalls strategy;
